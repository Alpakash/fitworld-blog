<script lang="ts">
	...
	import Posts from '$lib/components/organisms/Posts.svelte';
...
<div class="container">
  ...
  <div class="sib-form" style="text-align: center;">
	<div id="sib-form-container" class="sib-form-container">
	  ...
	  <div></div>
	  <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:15px; direction:ltr;box-shadow: var(--card-shadow);">
		<form id="sib-form" method="POST" action="https://15caa5a7.sibforms.com/serve/MUIFAMb4xjrEVfbGVqm6C9beXVBddGiFcG4CueqHG9U5qxOkhcpd_9EVGXfYzyV0lYNwBmEILAjgOVjlmdBVw5qY0qKuaCRD--D_ZAe69jSKDNZOJw5ycQjuSLP92fDpCw4N7DKYEcVJCgY-OsTsmEyZyRxLC0db9Ak6Z6EyZxwRo-ojyj5fHNqz9BFDtHLUYCIOaJB7h7JMrrFr" data-type="subscription">
		  <div style="padding: 8px 0;">
			<div class="sib-form-block" style="font-size:32px; text-align:left; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent; text-align:left">
			  <p>The Fitworld waitlist</p>
			</div>
		  </div>
		  <div style="padding: 8px 0;">
